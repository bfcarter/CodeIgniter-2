...
class Login extends CI_Controller {
     ...
     // Facebook OAuth Crediential
        private $appId = "142655082759044";
        private $secret = "f1019caf57a76118701e7fe205571c00";

     // Google OAuth Crediential 
        private $client_id = '218430018550-2dfhie2a8b9p4og2589h8vbj67064ag3.apps.googleusercontent.com';
        private $client_secret = 'DiyNZuAUTqJABcvBcBXRTqaf';
        private $redirect_uri = 'http://localhost/ci_loginapp_fb_google/login/google_login';
        private $simple_api_key = 'AIzaSyDWaDwJhdhg2x4Bf62l4MizxSO5V0Mnl20';
